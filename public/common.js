...
let UsuariosService = class UsuariosService {
    ...
    findUser(correo, clave) {
        /*this.afr.list('usuario').valueChanges().subscribe(res => {
          console.log("res" + JSON.stringify(res));
        });*/
        return this.afr.list('usuario', ref => ref.orderByChild('correo').equalTo(correo)).valueChanges();
    }
    findCorreo(correo) {
        return this.afr.list('usuario', ref => ref.orderByChild('correo').equalTo(correo)).valueChanges();
    }
    findId(cedula) {
        ...
        return this.afs.collection('usuario', ref => ref.where('cedula', '==', cedula).where('rol', '==', "cliente")).valueChanges();
    }
};
...
UsuariosService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
...
/* harmony export */ });
/* harmony import */ var D_Documentos_Tesis_GualaceoAR_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,D_Documentos_Tesis_GualaceoAR_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,D_Documentos_Tesis_GualaceoAR_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,D_Documentos_Tesis_GualaceoAR_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,D_Documentos_Tesis_GualaceoAR_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
